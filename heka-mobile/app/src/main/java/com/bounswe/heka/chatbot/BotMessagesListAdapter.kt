...
class BotMessagesListAdapter internal constructor(private val viewModel: ChatBotViewModel, private val userId: String) : ListAdapter<Message, RecyclerView.ViewHolder>(MessageDiffCallback()) {
    ...
    class ReceivedViewHolder(private val binding: ListItemMessageRecievedBinding) :
        ...
        fun bind(viewModel: ChatBotViewModel, item: Message) {
    ...
    override fun getItemViewType(position: Int): Int {
        return if (getItem(position).senderID != "me") {
